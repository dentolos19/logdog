    ...
    <div className={"min-h-screen bg-[#070b0f] text-white overflow-x-hidden"}>
      ...
      <nav className={"relative z-10 flex items-center justify-between px-6 py-4 max-w-7xl mx-auto"}>
        <div className={"flex items-center gap-2.5"}>
          ...
          <span className={"text-lg font-bold tracking-tight"}>naisc</span>
        </div>

        <div className={"hidden md:flex items-center gap-7 text-sm text-zinc-400"}>
          <Link href={"#formats"} className={"hover:text-white transition-colors duration-150"}>
            Formats
          </Link>
        ...
        <div className={"flex items-center gap-3"}>
          ...
          <Button
            size={"sm"}
            className={"bg-amber-400 text-zinc-900 hover:bg-amber-300 font-semibold shadow-none"}
            asChild
          >
      ...
      <section className={"relative z-10 px-6 pt-20 pb-28 max-w-7xl mx-auto text-center"}>
        ...
        >
          Drop in your raw logs — structured, unstructured, or anything in between. Naisc detects the schema, extracts
          the fields, and surfaces insights you can act on. No config files. No regex wrangling.
        </p>

        <div className={"animate-fade-up stagger-4 flex flex-col sm:flex-row gap-3 justify-center mb-20"}>
          <Button
            size={"lg"}
            className={
          ...
          >
            ...
            <div className={"border-r border-zinc-800"}>
              <div className={"flex items-center gap-2 px-4 py-3 border-b border-zinc-800 bg-zinc-900/60"}>
                ...
                <span className={"text-xs text-zinc-500 ml-2 font-mono"}>raw.log</span>
              ...
              <div className={"h-64 overflow-hidden relative px-5 py-4"}>
                <div
                  className={"animate-scroll-logs font-mono text-[11px] leading-[1.7] text-zinc-500 whitespace-nowrap"}
                >
                  {[...Array(2)].map((_, index) => (
                    <div key={index}>
                      <p>
            ...
            <div>
              <div
                className={"flex items-center justify-between gap-2 px-4 py-3 border-b border-zinc-800 bg-zinc-900/60"}
              >
                <div className={"flex items-center gap-2"}>
                  ...
                  <span className={"text-xs text-zinc-500 ml-2 font-mono"}>parsed output</span>
                </div>
              ...
              <div className={"p-5 h-64 overflow-hidden font-mono text-[11px] leading-[1.8]"}>
                <p className={"text-zinc-600 mb-1"}>{`// 1,042 rows — 9 fields extracted`}</p>
                <p>
      ...
      {/* ─── Format Showcase ─────────────────────────────────────── */}
      <section id={"formats"} className={"relative z-10 px-6 py-24 max-w-7xl mx-auto"}>
        <div className={"text-center mb-14"}>
          <p className={"text-xs font-mono text-amber-400 tracking-[0.2em] uppercase mb-3"}>Universal compatibility</p>
          <h2 className={"text-4xl md:text-5xl font-bold tracking-tight mb-4"}>Every format. One parser.</h2>
          ...
          <TabsContent value={"structured"}>
            <div className={"grid md:grid-cols-2 gap-10 items-start"}>
              <div>
                ...
                <h3 className={"text-2xl font-bold mb-3"}>Schema-aligned from the start</h3>
                <p className={"text-zinc-400 mb-7 leading-relaxed"}>
                  Structured logs already carry their schema. Naisc reads it, reconciles mixed formats, and loads
                  everything into a coherent unified table — even when fields drift across versions.
                </p>
                <ul className={"space-y-2.5"}>
                  {STRUCTURED_FORMATS.map((format) => (
                    <li key={format} className={"flex items-center gap-2.5 text-sm text-zinc-300"}>
              ...
              <div className={"rounded-xl overflow-hidden border border-zinc-800 bg-zinc-900/50 shadow-xl"}>
                <div className={"px-4 py-3 border-b border-zinc-800 flex items-center gap-2 bg-zinc-900/80"}>
                  ...
                  <span className={"text-xs text-zinc-500 font-mono ml-1"}>app.log (NDJSON)</span>
                </div>
                <pre
                  className={
          ...
          <TabsContent value={"semi"}>
            <div className={"grid md:grid-cols-2 gap-10 items-start"}>
              <div>
                ...
                <h3 className={"text-2xl font-bold mb-3"}>Pattern-extracted, fully structured</h3>
                <p className={"text-zinc-400 mb-7 leading-relaxed"}>
                  Semi-structured logs follow known conventions but aren't machine-readable out of the box. Naisc
              ...
              <div className={"rounded-xl overflow-hidden border border-zinc-800 bg-zinc-900/50 shadow-xl"}>
                <div className={"px-4 py-3 border-b border-zinc-800 flex items-center gap-2 bg-zinc-900/80"}>
                  ...
                  <span className={"text-xs text-zinc-500 font-mono ml-1"}>nginx/access.log</span>
                </div>
                <pre
                  className={
                    "px-5 py-5 text-[11px] font-mono text-zinc-300 overflow-x-auto leading-[1.8] whitespace-pre-wrap"
          ...
          <TabsContent value={"unstructured"}>
            <div className={"grid md:grid-cols-2 gap-10 items-start"}>
              <div>
                ...
                <h3 className={"text-2xl font-bold mb-3"}>Raw text, made queryable</h3>
                <p className={"text-zinc-400 mb-7 leading-relaxed"}>
                  No format at all? Naisc uses LLM-based extraction to find timestamps, severity, services, messages,
              ...
              <div className={"rounded-xl overflow-hidden border border-zinc-800 bg-zinc-900/50 shadow-xl"}>
                <div className={"px-4 py-3 border-b border-zinc-800 flex items-center gap-2 bg-zinc-900/80"}>
                  ...
                  <span className={"text-xs text-zinc-500 font-mono ml-1"}>crash_dump.txt</span>
                </div>
                <pre
                  className={
                    "px-5 py-5 text-[11px] font-mono text-zinc-300 overflow-x-auto leading-[1.8] whitespace-pre-wrap"
      ...
      >
        <div className={"max-w-7xl mx-auto"}>
          <div className={"text-center mb-16"}>
            <p className={"text-xs font-mono text-amber-400 tracking-[0.2em] uppercase mb-3"}>Simple by design</p>
          ...
          <div className={"grid md:grid-cols-3 gap-6"}>
            {STEPS.map(({ number, title, description, detail }, index) => (
              <div key={index} className={"relative"}>
                ...
                >
                  <div className={"text-6xl font-black text-amber-400/15 font-mono mb-5 leading-none select-none"}>
                    {number}
                  </div>
                  <h3 className={"text-xl font-semibold mb-3"}>{title}</h3>
                  <p className={"text-zinc-400 mb-5 text-sm leading-relaxed"}>{description}</p>
                  <div className={"text-xs font-mono text-zinc-600 border-t border-zinc-800 pt-4"}>{detail}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id={"features"} className={"relative z-10 px-6 py-24 max-w-7xl mx-auto"}>
        <div className={"text-center mb-16"}>
          <p className={"text-xs font-mono text-amber-400 tracking-[0.2em] uppercase mb-3"}>What you get</p>
          <h2 className={"text-4xl md:text-5xl font-bold tracking-tight mb-4"}>The whole pipeline, built in.</h2>
          <p className={"text-zinc-400 text-lg max-w-xl mx-auto"}>
            Naisc isn't just a parser. It's the entire ingestion-to-insight stack, ready to use from your first upload.
          </p>
        </div>
        ...
        <div className={"grid sm:grid-cols-2 lg:grid-cols-3 gap-5"}>
          {FEATURES.map(({ Icon, title, description }, index) => (
            ...
            >
              ...
              <CardContent>
                <CardDescription className={"text-zinc-400 leading-relaxed text-sm"}>{description}</CardDescription>
              </CardContent>
            </Card>
          ))}
        </div>
      ...
      <section className={"relative z-10 px-6 py-6 max-w-4xl mx-auto"}>
        <div
          className={"grid grid-cols-3 divide-x divide-zinc-800 border border-zinc-800 rounded-2xl overflow-hidden"}
          style={{ background: "rgba(255,255,255,0.015)" }}
        >
          {STATS.map(({ value, label }, index) => (
            <div key={index} className={"p-10 text-center"}>
              <div className={"text-5xl font-black text-amber-400 mb-2 font-mono"}>{value}</div>
      ...
      <section className={"relative z-10 px-6 py-32 text-center overflow-hidden"}>
        ...
        <div className={"relative"}>
          <p className={"text-xs font-mono text-amber-400 tracking-[0.2em] uppercase mb-5"}>Get started free</p>
          <h2
            className={
      ...
      <footer className={"relative z-10 border-t border-zinc-800/80 px-6 py-10"}>
        <div className={"max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-5"}>
          <div className={"flex items-center gap-2.5"}>
            <div className={"size-7 rounded-lg bg-amber-400 flex items-center justify-center shrink-0"}>
              <Terminal className={"size-3.5 text-zinc-900"} />
            </div>
            <span className={"font-bold text-sm"}>naisc</span>
          </div>

          <p className={"text-xs text-zinc-600"}>© 2026 Naisc. All logs welcome.</p>
