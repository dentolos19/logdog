...
EXTENSION_BINARY_SET: frozenset[str] = frozenset({
    ...
    ".lib", ".a", ".class", ".pyc", ".pyo", ".pyd", ".whl",
    ".egg", ".jar", ".war", ".dex", ".apk", ".ipa",
    ".iso", ".img", ".vhd", ".vmdk", ".qcow2",
    ".pcap", ".cap", ".dump", ".core", ".dmp",
    ".db", ".sqlite", ".s3db",
...
TEXT_LIKE_EXTENSIONS: frozenset[str] = frozenset({
    ".txt", ".log", ".csv", ".tsv", ".json", ".xml", ".yaml",
    ".yml", ".toml", ".cfg", ".conf", ".ini", ".md", ".rst",
    ".html", ".htm", ".xhtml", ".svg", ".css", ".js", ".jsx",
    ".ts", ".tsx", ".py", ".rb", ".sh", ".bash", ".zsh",
