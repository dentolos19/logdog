...
class LlmEngine:
    ...
    def discover_schema_from_records(
        ...
        prompt = (
            ...
            "- Also treat runtime/request metadata like cold_start, function_memory_size, "
            "function_arn, function_request_id, and xray_trace_id as first-class columns "
            "rather than putting them in extra\n"
    ...
    def extract_rows_from_records(
        ...
        prompt = (
            ...
            "- For the 'extra' column: put fields that do not have their own "
            ...
            "json fields, etc.\n"
            "- Exception: always give dedicated columns to common field names like "
            "cold_start, function_memory_size, function_arn, function_request_id, "
            "xray_trace_id, version, event_type, request_id, service, function_name, "
            "level, location, and severity — do NOT put these into 'extra'\n"
